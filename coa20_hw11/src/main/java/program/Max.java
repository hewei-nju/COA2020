...
public class Max {
	...
	public int max(int a, int b) {
		...
		String instrB = "";
		// Add
		instrA = "110001111000001100000000000000000000000000000000" + t.intToBinary(String.valueOf(a));
		instrB = "110001111000001100000000000000000000000000100000" + t.intToBinary(String.valueOf(b));
		...
		//System.out.println(CPU_State.ds.read() + offset);
